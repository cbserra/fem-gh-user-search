...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between">
      ...
      <label className="toggle flex uppercase hover:cursor-pointer" htmlFor="darkMode">
        <input
          className="sr-only"
          id="darkMode"
          type="checkbox"
        ...
        {/* <span className={`${darkMode ? 'hidden' : 'inline-flex'} toggle__button `}>
          Light
        ...
        <span className={`${darkMode ? 'inline-flex' : 'hidden'} toggle__button`}>
          Dark
          <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
            <path
